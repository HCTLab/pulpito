...
* RiscV ecosystem represents a new paradigm in RISC-based systems (due to its freedom). A huge ARM competitor has born and an interesting future is to come.
* However my thesis is based on the idea that proprietary and free ISAs can coexist in a same silicon (each ISA can take advantage of the other).
